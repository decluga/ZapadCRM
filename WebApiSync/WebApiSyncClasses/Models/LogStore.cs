    ...
    static class LogStore
    {
        ...
        private static void timer_Elapsed(object sender, ElapsedEventArgs e)
        {
                ...
                ConfigurationManager.ConnectionStrings["LocalDBConnectionString"].ConnectionString))
            {
                ...
                StringBuilder query = new StringBuilder("INSERT INTO Audit (WebAccountId, RequestInfo,RequestStart,RequestFinished," +
                        "AuthorizationCause, IsException, Answer, AuditInfo) VALUES");
                foreach (var logToDatabase in logsToDatabase)
                {
                    query.Append(string.Format("({0},'{1}','{2}','{3}','{4}','{5}','{6}','{7}'),",
                ...
                try
                    ...
                    {
                        query.Append(string.Format("INSERT INTO Audit (WebAccountId, RequestInfo,RequestStart,RequestFinished," +
